...
- [ ] 4b. Known-look item: splash screen is light (#eeeff0, matches logo) even in dark mode — intentional; tell testers it's not a bug
...
- [ ] 7. Play Console: create app (TruckersPro, free, Business) → paste listing from store/listing.md → upload screenshots + feature graphic → data safety + content rating (answers in listing.md) → privacy URL → proofread listing copy against the current app before submitting
